            ...
            <div class="card">
                <div class="card-header">
                    <button class="btn btn-outline-primary" data-toggle="button" id="addNew"> <span
                            class="icon-button"><i class="fa fa-plus"></i></span> New Customer</button>
                </div>
                            ...
                            @foreach ($customerData as $row)
                                ...
                                <tr>
                                    ...
                                    <td> <a href="#adress" class="btn btn-primary btn-sm address"
                                            data-id=" {{ $row->customerid }} "> View</a> </td>
                                    <td> {{ date('d-M-Y', strtotime($row->register_date)) }} </td>
                                    <td> {!! $photo !!} </td>
                                    <td> {!! $status !!} <a href="#edit_status"
                                            data-id="{{ $row->customerid }}" class="edit_status">
                                            <i class=" fa fa-edit"></i>
                                        </a> </td>
                                    <td>
                                        <a href="{{ url('/customer/cart_detail/' . $row->customerid . '') }}"
                                            class="text-primary"> <i class="fa fa-shopping-cart"></i>
                                        </a> |
                                        <a href="#edit_name" class="edit text-primary edit"
                                            data-id=" {{ $row->customerid }} "> <i class="fa fa-edit"></i> </a> |
                                        <a href="#delete" class="delete text-danger delete"
                                            data-id="{{ $row->customerid }}"> <i class="fa fa-trash"></i> </a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
