...
try {
	$sql = "SELECT p.productid,p.productname,p.price,p.images,p.categoryid, c.categoryname 
	from tblproduct as p left JOIN tblcategory as c on p.categoryid = c.categoryid  
	where p.price BETWEEN '$minprice' and '$maxprice' and c.categoryname = '$categoryname'  and p.status =1;";
