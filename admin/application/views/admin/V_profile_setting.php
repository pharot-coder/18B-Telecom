    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php echo form_open('admin/C_profile_setting/editProfile', ['id' => 'profile_form', 'method' => 'POST']) ?>
                    ...
                    <div class="row">
                        <div class="col-md-4 border-right">
                            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img
                                    class="rounded-circle mt-5" src="../assets/img/<?php echo $row->images ?>"
                                    width="200"><span><a href="#" id="editPhoto" data-id="<?php echo $row->userid ?>"
